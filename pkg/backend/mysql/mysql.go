...
func (msql *MysqlBackend) StoreSession(sessionId string, session *session.Session) bool {
	return false
}

func (msql *MysqlBackend) DoesSessionExist(sessionId string) (*session.Session, bool) {
	return nil, false
}

func (msql *MysqlBackend) GetSessionHistory(sessionId string) ([]session.Message, bool) {
	return nil, false
}
