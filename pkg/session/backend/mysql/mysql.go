...
func (b *MysqlBackend) HasClient(name string) bool {
	return true
}

func (b *MysqlBackend) MatchClientPassword(name string, password string) bool {
	return true
}

func (b *MysqlBackend) RegisterNewClient(name string, addr string, status string, password string, connTime time.Time) bool {
	return true
}

func (b *MysqlBackend) AddMessage(name string, contents_ []byte, sentTime_ time.Time) bool {
	return true
}
